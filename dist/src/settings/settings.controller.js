...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get user settings and salary rule' }),
...
__decorate([
    (0, common_1.Put)('salary-rule'),
    (0, swagger_1.ApiOperation)({ summary: 'Update salary rule' }),
    __param(0, (0, common_2.CurrentUser)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, settings_dto_1.UpdateSalaryRuleDto]),
    __metadata("design:returntype", void 0)
], SettingsController.prototype, "updateSalaryRule", null);
